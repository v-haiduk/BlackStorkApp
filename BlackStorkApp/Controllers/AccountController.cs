...
namespace BlackStorkApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        /// <summary>
        /// The method performs operations to configure the sending of messages
        /// </summary>
        /// <param name="emailOfSender">The email of user, which get a message</param>
        /// <param name="password">The password of smtp-client</param>
        /// <param name="message">The message, which get a user</param>
